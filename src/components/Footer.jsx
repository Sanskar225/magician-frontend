        ...
        <div className={styles.grid}>
          ...
          >
            ...
            <p className={styles.tagline}>
              ...
              <span className={styles.signature}>— Parth</span>
            </p>
          ...
          >
            ...
            <ul className={styles.linkList}>
              {[
                ...
                { to: "/contact", label: "Summon Parth", icon: "🔮" },
              ].map(({ to, label, icon }) => (
          ...
          >
            ...
            <ul className={styles.contactList}>
              <li className={styles.contactItem}>
                ...
                <a
                  href={`mailto:${EMAIL}`}
                  className={`${styles.footerLink} ${styles.contactLink}`}
                >
                  {EMAIL}
                </a>
              </li>
        ...
        <div className={styles.mysticalBottom}>
          ...
          <div className={styles.bottomContent}>
            ...
            <div className={styles.legalLinks}>
              <Link
                to="/privacy"
                className={`${styles.legalLink} ${styles.mysticalLink}`}
              >
