...
const defaultServices = [
  {
    ...
    description:
      "Transform your event into a theatrical experience with large-scale stage illusions. From levitation to disappearing acts, these performances command attention and create memories that last a lifetime.",
    icon: "🎭",
    features: [
      "Full stage setup",
      "Theatrical lighting",
  ...
  },
  {
    ...
    description:
      "Experience magic that happens right in your hands. Cards, coins, and everyday objects transform in ways that defy rational explanation, creating personal moments of wonder for each guest.",
    icon: "🃏",
    features: [
      "Table-to-table performance",
      "Interactive effects",
      "No setup required",
      "Perfect for cocktail hours",
      "Custom themed effects",
    ],
    price: "From $1,500",
    isPopular: false,
  },
  {
    ...
    description:
      "Elevate your corporate gathering with tailored magic that incorporates your brand messaging. From product launches to annual galas, Parth creates memorable moments that reinforce your company values.",
    icon: "🏢",
    features: [
      "Brand integration",
      "Keynote-style performances",
  ...
  },
  {
    ...
    description:
      "Add an enchanting element to your wedding celebration. Parth performs customized shows that reflect your love story, creating wonder-filled moments that guests talk about for years.",
    icon: "💍",
    features: [
  ...
  },
  {
    ...
    description:
      "Journey into the realm of the mind with Parth's mentalism performances. Watch as he reads thoughts, predicts the future, and demonstrates seemingly impossible feats of psychological prowess.",
    icon: "🔮",
    features: [
  ...
  },
  {
    ...
    description:
      "Magic without boundaries. Parth delivers astonishing performances directly through your screen, creating shared moments of wonder for remote teams, online events, and virtual gatherings.",
    icon: "💻",
    features: [
      "Zoom/Teams compatible",
      "Screen magic effects",
      "Interactive participation",
      "Global reach",
      "No equipment needed for viewers",
    ],
    price: "From $800",
    isPopular: false,
  },
...
export default function Services() {
  ...
  useEffect(() => {
    serviceAPI
      .getAll()
      .then((r) => {
        const list = r?.data?.services?.length
          ? r.data.services
          : defaultServices;
        setServices(list);
        if (identifier) {
          setSelectedService(
            list.find((s) => s.slug === identifier || s.id === identifier) ||
              null,
          );
        }
      })
      .catch(() => {
        ...
        if (identifier) {
          setSelectedService(
            defaultServices.find((s) => s.slug === identifier) || null,
          );
        }
      })
    ...
    return (
      <>
        <SEOHead
          ...
          canonicalPath={`/services/${identifier}`}
        />
    ...
    <>
      ...
      <main className="page-transition">
        ...
        <section className={styles.hero} ref={vantaHeroRef}>
          ...
          <div className="container">
            <div className={`text-center reveal`} ref={useScrollReveal()}>
              <div className="section-label">What Parth Offers</div>
              ...
              <p className="section-subtitle" style={{ margin: "0 auto" }}>
                ...
                Parth crafts each performance to perfectly suit your event.
              </p>
            </div>
          </div>
        </section>
              ...
              {[
                {
                  step: "01",
                  title: "Enquire",
                  desc: "Share your event details and vision with us",
                },
                {
                  step: "02",
                  title: "Consult",
                  desc: "We tailor the perfect performance for your needs",
                },
                {
                  step: "03",
                  title: "Confirm",
                  desc: "Lock in the date with a simple booking process",
                },
                {
                  step: "04",
                  title: "Be Amazed",
                  desc: "Experience magic that exceeds all expectations",
                },
              ].map(({ step, title, desc }) => (
          ...
          <div className="container">
            <div className="reveal" ref={useScrollReveal()}>
              ...
              <p className="section-subtitle" style={{ margin: "0 auto 2rem" }}>
                Contact Parth to discuss your event and create something truly
                magical.
              </p>
              <Link to="/contact" className="btn btn-primary">
                Get in Touch ✦
