...
const milestones = [
  {
    year: "2005",
    event: "First professional performance at The Palace Hotel, Las Vegas",
    icon: "🌟",
  },
  {
    year: "2009",
    event: "Headlined at the Edinburgh International Magic Festival",
    icon: "🎭",
  },
  {
    year: "2013",
    event: "World record for largest audience for a close-up magic show",
    icon: "🏆",
  },
  {
    year: "2016",
    event: 'Netflix Special "Impossible: The Parth Chronicles"',
    icon: "🎬",
  },
  {
    year: "2019",
    event: "Performed for 3 world leaders at the International Summit",
    icon: "🌍",
  },
  {
    year: "2024",
    event: "Celebrating 20 years of magical performances worldwide",
    icon: "✦",
  },
];
...
export default function About() {
  ...
  return (
    <>
      <SEOHead
        title="About Parth"
        description="The story of Parth the Illusionist — 20 years of world-class magic, from Las Vegas to London and beyond."
        canonicalPath="/about"
      />
      ...
      <main className="page-transition">
            ...
            <div className={`${styles.heroInner} reveal`} ref={heroRef}>
              <div className={styles.heroText}>
                ...
                <p className={styles.heroDesc}>
                  Parth discovered his passion for magic at age seven, when a
                  worn deck of cards became his first gateway into the
                  extraordinary. Today, he stands as one of the world&rsquo;s
                  most celebrated illusionists, having performed across 15
                  countries for over half a million people.
                </p>
                <p className={styles.heroDesc}>
                  His art transcends entertainment — it&rsquo;s an exploration
                  of wonder, perception, and the magic that exists within every
                  human connection.
                </p>
                <Link
                  to="/contact"
              ...
              <div className={styles.heroImage}>
                <div className={styles.imagePlaceholder}>
                  ...
                  <div className={styles.imageText}>Parth</div>
        ...
        <section className={`section ${styles.philosophy}`}>
          <div className="container">
            <div
              className={`${styles.philosophyInner} reveal`}
              ref={philosophyRef}
            >
              <div className={styles.philosophyQuote}>
                <div className={styles.quoteMark}>&ldquo;</div>
                <blockquote className={styles.quoteText}>
                  Magic is not about deception. It&rsquo;s about creating a
                  moment where belief and reality dance together, and for a
                  breath of time, anything becomes possible.
                </blockquote>
                <div className={styles.quoteAuthor}>— Parth</div>
              </div>
            </div>
          </div>
        </section>
